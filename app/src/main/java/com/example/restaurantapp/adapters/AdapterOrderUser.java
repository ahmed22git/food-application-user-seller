...
import com.example.restaurantapp.activities.OrderDetailsUsersActivity;
...
public class AdapterOrderUser extends RecyclerView.Adapter<AdapterOrderUser.HolderOrderUser> {
    ...
    public void onBindViewHolder(@NonNull HolderOrderUser holder, int position) {
        ...
        if(orderStatus.equals("In Progress")){
            ...
            holder.statusTv.setTextColor(context.getResources().getColor(R.color.gray));
    ...
    private void loadShopInfo(ModelOrderUser modelOrderUser, HolderOrderUser holder) {
        ...
        ref.child(modelOrderUser.getOrderId())
